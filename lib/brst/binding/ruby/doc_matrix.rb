    ...
    module Ruby
      module DocMatrix
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_Doc_Matrix_Identity, [:Doc], :Matrix
          safe_attach :BRST_Doc_Matrix_Free, [:Matrix], :void
          safe_attach :BRST_Doc_Matrix_Multiply, [:Doc, :Matrix, :Matrix], :Matrix
          safe_attach :BRST_Doc_Matrix_Translate, [:Doc, :Matrix, :float, :float], :Matrix
          safe_attach :BRST_Doc_Matrix_Scale, [:Doc, :Matrix, :float, :float], :Matrix
          safe_attach :BRST_Doc_Matrix_Rotate, [:Doc, :Matrix, :float], :Matrix
          safe_attach :BRST_Doc_Matrix_RotateDeg, [:Doc, :Matrix, :float], :Matrix
          safe_attach :BRST_Doc_Matrix_Skew, [:Doc, :Matrix, :float, :float], :Matrix
      end
    end
  end
end
