    ...
    module Ruby
      module DocImageTiff
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_Doc_Image_Raw1Bit_LoadFromMemory, [:Doc, :pointer, :uint32, :uint32, :uint32, :int32, :int32], :Image
          safe_attach :BRST_Doc_Image_Raw_LoadFromFile, [:Doc, :string, :uint32, :uint32, :ColorSpace], :Image
          safe_attach :BRST_Doc_Image_Raw_LoadFromMemory, [:Doc, :pointer, :uint32, :uint32, :ColorSpace, :uint32], :Image
      end
    end
  end
end
