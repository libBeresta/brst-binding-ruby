    ...
    module Ruby
      module DocImagePng
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_Doc_Image_Png_LoadFromMemory, [:Doc, :pointer, :uint32], :Image
          safe_attach :BRST_Doc_Image_Png_LoadFromFile, [:Doc, :string], :Image
          safe_attach :BRST_Doc_Image_Png_LoadFromFile2, [:Doc, :string], :Image
      end
    end
  end
end
