    ...
    module Ruby
      module DocEncoder
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_Doc_Encoder_SetCurrent, [:Doc, :string], :uint32
          safe_attach :BRST_Doc_Encoder_Prepare, [:Doc, :string], :Encoder
          safe_attach :BRST_Doc_Encoder_Current, [:Doc], :Encoder
      end
    end
  end
end
