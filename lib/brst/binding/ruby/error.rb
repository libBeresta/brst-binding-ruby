    ...
    module Ruby
      module Error
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_Error_Check, [:Error], :uint32
          safe_attach :BRST_Doc_Error_Code, [:Doc], :uint32
          safe_attach :BRST_Doc_Error_DetailCode, [:Doc], :uint32
          safe_attach :BRST_Doc_Error_Reset, [:Doc], :void
          safe_attach :BRST_Doc_Error_SetHandler, [:Doc, :pointer], :uint32
      end
    end
  end
end
