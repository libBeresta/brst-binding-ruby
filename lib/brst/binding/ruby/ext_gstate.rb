    ...
    module Ruby
      module ExtGstate
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_ExtGState_SetAlphaStroke, [:ExtGState, :float], :uint32
          safe_attach :BRST_ExtGState_SetAlphaFill, [:ExtGState, :float], :uint32
          safe_attach :BRST_ExtGState_SetBlendMode, [:ExtGState, :BlendMode], :uint32
      end
    end
  end
end
