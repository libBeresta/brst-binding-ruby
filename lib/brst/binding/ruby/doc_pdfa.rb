    ...
    module Ruby
      module DocPdfa
        ...
        def self.safe_attach(name, args, ret)
          ...
          safe_attach :BRST_Doc_PDFA_SetConformance, [:Doc, :PDFAType], :uint32
          safe_attach :BRST_Doc_PDFA_AddXmpExtension, [:Doc, :string], :uint32
          safe_attach :BRST_Doc_PDFA_AppendOutputIntents, [:Doc, :string, :Dict], :uint32
      end
    end
  end
end
